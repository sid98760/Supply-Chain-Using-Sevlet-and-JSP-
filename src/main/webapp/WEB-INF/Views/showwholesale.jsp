...
<%
	try
	{
		...
		String query = "SELECT * FROM wholesale_table";
...
%>
	...
	<tr>
		<td><%=rs.getString("wholesaler_id")  %></td>
		<td><%=rs.getString("wholesale_name")  %></td>
		<td><%=rs.getString("product_name")  %></td>
		<td><%=rs.getString("quantity")  %></td>
		<td><%=rs.getString("wholesale_date")  %></td>
		<td><%=rs.getString("wholesale_amount")  %></td>
