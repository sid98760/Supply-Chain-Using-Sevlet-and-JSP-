...
<br><br><br><br>
 ...
 <div align="center">
  ...
  <br>
  <h3>This is the data for product which is stored Successfully</h3>
  <br>
...
<%
	try
	{
		...
		String query = "SELECT * FROM manufacture_table";
...
%>
	...
	<tr>
		<td><%=rs.getString("packet_id")  %></td>
		<td><%=rs.getString("product_id")  %></td>
		<td><%=rs.getString("product_name")  %></td>
		<td><%=rs.getString("factory_name")  %></td>
		<td><%=rs.getString("manufacture_amount")  %></td>
